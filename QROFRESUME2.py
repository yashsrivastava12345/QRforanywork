...
pdf_path = 'C:/Users/yashs/Desktop/RESUMEQR/testimageconversion.pdf'
...
# Generate QR code
qr = qrcode.QRCode(
    version=None,  # Let qrcode determine the version automatically
    #error_correction=qrcode.constants.ERROR_CORRECT_L,
    box_size=10,
    border=4,
)
qr.add_data(encoded_pdf, optimize=20)
qr.make()
